...
export const P1_EP_PRESET = PresetUtils.makePresetEpWeights(
	...
	Stats.fromMap(
		{
			[Stat.StatMana]: 0.03,
			[Stat.StatIntellect]: 1.4,
			[Stat.StatSpirit]: 0.89,
			[Stat.StatSpellDamage]: 1,
			[Stat.StatArcaneDamage]: 0.93,
			[Stat.StatFrostDamage]: 0.08,
			[Stat.StatSpellHitRating]: 2.28,
			[Stat.StatSpellCritRating]: 0.8,
			[Stat.StatSpellHasteRating]: 0.7,
			[Stat.StatSpellPenetration]: 0,
			[Stat.StatMP5]: 0.53,
		},
		{
			[PseudoStat.PseudoStatSchoolHitPercentArcane]: 2.28,
	...
	Stats.fromMap(
		{
			...
			[Stat.StatSpirit]: 0.81,
			[Stat.StatSpellDamage]: 1,
			[Stat.StatArcaneDamage]: 0.88,
		...
		{
			[PseudoStat.PseudoStatSchoolHitPercentArcane]: 2.3,
